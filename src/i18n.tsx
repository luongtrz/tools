...
const messages = {
  vi: {
    ...
    copyInstructionDescription: "Dán nguyên block này vào agent. Agent sẽ tự kết nối MCP remote, kiểm tra authentication và biết khi nào nên gọi toolmd.",
    ...
    tokenLabel: "Bearer token (không lưu vào trình duyệt)",
    tokenPlaceholder: "Dán MCP_AUTH_TOKEN vào đây để tạo config",
    tokenDescription: "Token chỉ được dùng để tạo block config trong phiên hiện tại; không commit token vào code hoặc README.",
    remoteMcpNote: "Sau khi dán config vào AI host, yêu cầu agent gọi toolmd_catalog. Không cần cài package hay chạy command local.",
  ...
  en: {
    ...
    copyInstructionDescription: "Paste this block into your agent. It will connect to remote MCP, verify authentication and know when to call toolmd.",
    ...
    note: "Note:",
    endpointLabel: "MCP endpoint",
    tokenLabel: "Bearer token (not stored in the browser)",
    tokenPlaceholder: "Paste MCP_AUTH_TOKEN here to generate the config",
    tokenDescription: "The token is only used to generate the config in this session; never commit it to code or README.",
    remoteMcpNote: "After pasting the config into your AI host, ask the agent to call toolmd_catalog. No package installation or local command is required.",
