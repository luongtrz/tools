...
export default function MarkdownPreview({
  ...
  return (
    <section className="flex min-w-0 flex-col border-t border-border dark:border-border lg:border-l lg:border-t-0">
      ...
      <div className="flex min-h-[420px] flex-1 justify-center overflow-auto bg-muted/50 p-5 dark:bg-muted/30 dark:[&>article]:bg-card dark:[&>article]:text-foreground dark:[&>article_h1]:text-foreground dark:[&>article_h2]:text-foreground dark:[&>article_h3]:text-foreground sm:p-7">
        {html ? (
          <article
