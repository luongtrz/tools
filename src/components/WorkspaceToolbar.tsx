  ...
  return (
    <div className="flex min-h-[88px] flex-col items-start justify-between gap-4 border-b border-slate-200 px-5 py-4 dark:border-slate-800 lg:flex-row lg:items-center lg:px-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <strong className="block text-base font-semibold text-[#111b2c] dark:text-slate-100">{fileName}.md</strong>
      ...
      <div className="flex w-full flex-wrap items-center justify-start gap-2 lg:w-auto lg:justify-end">
        ...
        <button className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-slate-100 px-4 text-sm font-semibold text-slate-600 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700" type="button" onClick={onDownload}>
